...
class _AnimalDetalleScreenState extends State<AnimalDetalleScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final desparasitado =
        (animal['desparasitado'] as String?) ?? 'Aún no lo sé';
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: fotos.isEmpty
                    ...
                    : () => context.push(
                        AppRoutes.visorFoto,
                        extra: (fotos: fotos, indiceInicial: _paginaFoto),
                      ),
                child: Stack(
                  children: [
                    ClipRRect(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        if (ubicacion.isNotEmpty && edad.isNotEmpty)
                    ...
                    Text(
                      [
                        raza,
                        if (genero.isNotEmpty && genero != 'No sé') genero,
                ...
                children: [
                  Expanded(
                    child: GestureDetector(
                      onTap: () => context.push(
                        AppRoutes.chat,
                        extra: (animal: animal, esRescatista: false, chatId: null),
                      ),
                      child: Container(
  ...
  Widget _circleBtn(IconData icon, VoidCallback onTap, {String? label}) =>
      Tooltip(
        message: label ?? '',
        child: GestureDetector(
          onTap: onTap,
  ...
  Widget _pill(IconData? icon, String text) => Container(
    ...
    child: Row(
      ...
      children: [
        if (icon != null) ...[
          Icon(icon, size: 12, color: appTeal),
