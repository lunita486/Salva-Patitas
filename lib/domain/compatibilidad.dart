...
List<_Criterio> _desglose(Map<String, dynamic> sol) {
  ...
  if (energia == 'Tranquilo') {
    ...
    energiaC = horas <= 8
        ...
        : (
            'Animal activo pero pasa demasiadas horas solo ($horas h/día)',
            false,
            10,
          );
    ...
    energiaC = (
      'Animal muy activo, tiene jardín pero $horas h solo',
      false,
      10,
    );
  } else if (horas <= 6) {
    ...
    energiaC = (
      'Animal muy activo, necesita jardín y menos horas solo',
      false,
      0,
    );
  }
  ...
  } else if (vivienda == 'Apartamento con balcón' ||
